...
# Search for all available Windows updates
Write-Verbose "Searching for available Windows updates..."
...
if ($updates) {
    ...
    Write-Verbose "No Windows updates found."
    exit 0
}

# Download and install updates without reboot prompt
Write-Verbose "Downloading and installing Windows updates..."
...
Write-Verbose "Windows update process completed! Note: Some updates may require a manual reboot later."